import{_ as T}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{c as x,a as v,b as f,d as c,e as b,u as w,f as g,g as z,h as P,i as _,F as R,j as H,k as m,t as N,o as S,l as j,m as e,w as n,n as C,p as i}from"./index-rMr_1vKx.js";import{N as L,a as O}from"./headers-DrPf7GBP.js";import{_ as D}from"./p-BLmyAVBu.js";const E=x("divider",`
 position: relative;
 display: flex;
 width: 100%;
...
`,[v("vertical",`
 ...
 `),m("&:last-child",`
 margin-bottom: 0;
 `)],G=m([x("ol",{fontSize:"var(--n-font-size)",padding:"var(--n-ol-padding)"},[c("align-text",{paddingLeft:0}),y,$]),x("ul",{fontSize:"var(--n-font-size)",padding:"var(--n-ul-padding)"},[c("align-text",{paddingLeft:0}),y,$])]),I=Object.assign(Object.assign({},g.props),{alignText:Boolean}),W=b({name:"Ul",props:I,setup(o){const{mergedClsPrefixRef:r,inlineThemeDisabled:d}=w(o),a=g("Typography","-xl",G,N,o,r),s=z(()=>{const{common:{cubicBezierEaseInOut:t},self:{olPadding:u,ulPadding:h,liMargin:p,liTextColor:k,liLineHeight:B,liFontSize:V}}=a.value;return{"--n-bezier":t,"--n-font-size":V,"--n-line-height":B,"--n-text-color":k,"--n-li-margin":p,"--n-ol-padding":u,"--n-ul-padding":h}}),l=d?P("ul",void 0,s,o):void 0;return{mergedClsPrefix:r,cssVars:d?void 0:s,themeClass:l==null?void 0:l.themeClass,onRender:l==null?void 0:l.onRender}},render(){var o;const{mergedClsPrefix:r}=this;return(o=this.onRender)===null||o===void 0||o.call(this),_("ul",{class:[`${r}-ul`,this.themeClass,this.alignText&&`${r}-ul--align-text`],style:this.cssVars},this.$slots)}}),U=b({name:"Li",render(){return _("li",null,this.$slots)}}),Z={},q=C("div",{style:{"max-width":"750px",margin:"0px auto"}},[C("img",{src:"https://img2.imgtp.com/2024/05/23/9kGGvZ01.jpg",alt:"",style:{display:"block",width:"100%"}})],-1);function A(o,r){const d=L,a=O,s=D,l=M,t=U,u=W;return S(),j(R,null,[e(d,null,{default:n(()=>[i("斯普拉遁3 🏆小白杯")]),_:1}),e(a,{prefix:"bar"},{default:n(()=>[i(" 报名流程 ")]),_:1}),e(s,null,{default:n(()=>[i(" 需要玩家提供SW码以及游戏内的玩家名称。（活动期间尽量不要修改玩家名称） ")]),_:1}),e(l),e(a,{prefix:"bar"},{default:n(()=>[i(" 活动时间 ")]),_:1}),e(u,null,{default:n(()=>[e(t,null,{default:n(()=>[i(" 开始时间：2024-05-25（周六）")]),_:1}),e(t,null,{default:n(()=>[i(" 结束时间：2024-06-14（周五）")]),_:1})]),_:1}),e(l),e(a,{prefix:"bar"},{default:n(()=>[i(" 活动流程 ")]),_:1}),e(u,null,{default:n(()=>[e(t,null,{default:n(()=>[i("参加的玩家首先需要报名")]),_:1}),e(t,null,{default:n(()=>[i("每场对局需要8名玩家和1名裁判，裁判进入观看席位")]),_:1}),e(t,null,{default:n(()=>[i("由裁判创建房间，设置房间参数（随机地图、取消追加能力等等）")]),_:1}),e(t,null,{default:n(()=>[i("8名玩家随机分成两组对战")]),_:1}),e(t,null,{default:n(()=>[i("时间结束，涂地面积多的获胜")]),_:1})]),_:1}),e(l),e(a,{prefix:"bar"},{default:n(()=>[i(" 注意事项 ")]),_:1}),e(u,null,{default:n(()=>[e(t,null,{default:n(()=>[i("禁止使用“2024夏季赛”新武器参与活动")]),_:1}),e(t,null,{default:n(()=>[i("禁止使用其他账号参与活动")]),_:1})]),_:1}),e(l),e(a,{prefix:"bar"},{default:n(()=>[i(" 计分规则 ")]),_:1}),e(u,null,{default:n(()=>[e(t,null,{default:n(()=>[i("胜利组 每人+1分 ")]),_:1}),e(t,null,{default:n(()=>[i("失败组 每人-1分")]),_:1})]),_:1}),e(s,null,{default:n(()=>[i("如果存在玩家掉线，导致游戏中断或继续，本次对局都视为无效。")]),_:1}),e(s,null,{default:n(()=>[i(" 最终会从玩家所有对局中随机选出20局，合计得出最终得分。（不满20局的，剩余场次均按照失败计算） ")]),_:1}),e(l),e(a,{prefix:"bar"},{default:n(()=>[i(" 活动奖励 ")]),_:1}),e(s,null,{default:n(()=>[i("本活动由小白独家赞助💰")]),_:1}),e(s,null,{default:n(()=>[i("本次活动第一名可以获得《斯普拉遁3》amiibo手办任选一个")]),_:1}),q],64)}const Y=T(Z,[["render",A]]);export{Y as default};
